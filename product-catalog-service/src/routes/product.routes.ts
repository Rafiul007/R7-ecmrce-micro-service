...
router.post(
  ...
  [
    ...
    body('availableInStore').optional().isBoolean(),
    body('availableOnline').optional().isBoolean(),
    body('weightKg').optional().isFloat({ min: 0 }),
    body('dimensions').optional().isObject(),
    body('dimensions.lengthCm').optional().isFloat({ min: 0 }),
    body('dimensions.widthCm').optional().isFloat({ min: 0 }),
    body('dimensions.heightCm').optional().isFloat({ min: 0 }),
